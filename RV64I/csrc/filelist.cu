...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _123276_archive_1.so
_123276_archive_1.so : archive.21/_123276_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_123276_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_123276_archive_1.so $@
